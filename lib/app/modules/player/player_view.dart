          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: isCurrentLine ? Colors.red : Colors.white.withOpacity(0.5),
  ...
  Widget _buildBottomControlsPanel() {
    return ClipRRect(
      child: BackdropFilter(
        ...
        child: Container(
          padding: const EdgeInsets.fromLTRB(20, 15, 20, 25), // 底部留出更多安全距离
          decoration: BoxDecoration(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          title: Text(song.title,
                              style: TextStyle(color: isActive ? Colors.amberAccent : Colors.white, fontWeight: isActive ? FontWeight.bold : FontWeight.normal),
                              maxLines: 1),
